            ...
            <div class="tab">
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example" name="jk" id="jk"
                            required>
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" placeholder="Nomor Induk Kependudukan" name="nik" value="{{ old('nik') }}"
                            required>
                    </div>
                    <div class="input-field">
                        <label>Anak Ke-</label>
                        <input type="text" placeholder="Anak Ke-" name="anak_ke" value="{{ old('anak_ke') }}" required>
                    </div>
                    <div class="input-field">
                ...
                <div class="fields">
                    <div class="input-field">
                        ...
                        <textarea class="form-control" name="alamat_tempat_tinggal" id="alamat_tempat_tinggal"
                            placeholder="Alamat Tempat Tinggal..." rows="3"
                            required>{{ old('alamat_tempat_tinggal') }}</textarea>
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Enter expiry date" name="kab" value="{{ old('kab') }}" required>
                    </div>
                    <div class="input-field">
                        <label>Provinsi</label>
                        <input type="Text" placeholder="Enter expiry date" name="prov" value="{{ old('prov') }}"
                            required>
                    </div>
                    <div class="input-field">
                        <label>Kode Pos</label>
                        <input type="Text" placeholder="Enter expiry date" name="kode_pos" value="{{ old('kode_pos') }}"
                            required>
                    </div>
                </div>
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example"
                            ...
                            <option value="{{ $p->id }}" {{ old('id_pendidikan_ayah')==$p->id ? 'selected' : '' }}>
                                {{ $p->nama_pendidikan }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example"
                            ...
                            <option disabled selected>Pilih Pendidikan Terakhir</option>
                            @foreach ($pendidikan as $p)
                            <option value="{{ $p->id }}" {{ old('id_pendidikan_ibu')==$p->id ? 'selected' : '' }}>
                                {{ $p->nama_pendidikan }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example"
                            ...
                            <option disabled selected>Pilih Pendidikan Terakhir</option>
                            @foreach ($pendidikan as $p)
                            <option value="{{ $p->id }}" {{ old('id_pendidikan_wali')==$p->id ? 'selected' : '' }}>
                                {{ $p->nama_pendidikan }}
                            </option>
                            @endforeach
                        </select>
            ...
            <div class="tab">
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Permanent or Temporary" name="jarak" value="{{ old('jarak') }}"
                            required>
                    </div>
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example"
                            ...
                            @foreach ($trans as $t)
                            <option value="{{ $t->id_jenis_transportasi }}" {{ old('id_jenis_transport')==$t->
                                id_jenis_transportasi ? 'selected' : '' }}>
                                {{ $t->nama_transportasi }}
                            </option>
                            @endforeach
                        </select>
            ...
            <div class="tab">
                ...
                <div class="fields">
                    <div class="input-field">
                        ...
                        <select class="form-control form-select" aria-label="Default select example" name="id_goldar"
                            id="id_goldar" required>
                            <option disabled selected>Pilih Jenis Transportasi</option>
                            @foreach ($goldar as $g)
                            <option value="{{ $g->id_goldar }}" {{ old('id_goldar')==$g->id_goldar ? 'selected' : '' }}>
                                {{ $g->goldar }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" placeholder="Permanent or Temporary" name="bb" value="{{ old('bb') }}"
                            required>
                    </div>

                    <div class="input-field">
                        <label>Tinggi Badan</label>
                        <input type="number" placeholder="Permanent or Temporary" name="tb" value="{{ old('tb') }}"
                            required>
                    </div>
                    <div class="input-field">
