                          ...
                          <form id="data_pribadi" enctype="multipart/form-data" action="{{ url('update_pribadi') }}"
                              ...
                              <div class="row g-2">
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="kewarganegaraan" value="{{ $detail->kewarganegaraan }}" required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="alamat_tempat_tinggal" value="{{ $detail->alamat_tempat_tinggal }}"
                                          required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="ket_tinggal" value="{{ $detail->ket_tinggal }}" required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="jml_saudara" value="{{ $detail->jml_saudara }}" required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <select class="form-select" name="id_goldar" id="id_goldar" required>
                                          @foreach ($goldar as $g)
                                              <option value="{{ $g->id_goldar }}"
                                                  {{ $g->id_goldar == $detail->id_goldar ? 'selected' : '' }}>
                                                  {{ $g->goldar }}</option>
                                          @endforeach
                                      </select>
                                  </div>
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="riwayat_penyakit" value="{{ $detail->riwayat_penyakit }}" required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                                      <label for="inputZip" class="form-label">Kelainan Jasmani</label>
                                      <input type="text" id="example-fileinput" class="form-control"
                                          name="kelainan_jasmani" value="{{ $detail->kelainan_jasmani }}" required>
                                  </div>
                                  <div class="mb-3 col-md-2">
                              ...
                              <div class="row g-2">
                                  ...
                                  <div class="mb-3 col-md-2">
                                      ...
                                      <select class="form-select" name="id_jenis_transport" id="id_jenis_transport"
                                          required>
                                          @foreach ($trans as $tr)
                                              <option value="{{ $tr->id_jenis_transportasi }}"
                                                  {{ $tr->id_jenis_transportasi == $detail->id_jenis_transport ? 'selected' : '' }}>
