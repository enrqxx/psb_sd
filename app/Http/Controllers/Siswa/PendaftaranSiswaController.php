    ...
    public function addData(Request $request)
    {
        ...
        $this->validate(
            ...
            [
                ...
                'nik.required'  => 'NIK sudah terdaftar/NIK belum terisi.',
                'anak_ke.required'  => 'Anak Ke- wajib diisi.',
                'bahasa_sehari.required'  => 'Bahasa wajib diisi.',
                'kewarganegaraan.required'  => 'Isikan Kewarganegaraan.',
                'jk.required'  => 'Jenis Kelamin wajib diisi.',
                'alamat_tempat_tinggal.required'  => 'Alamat Tempat Tinggal wajib diisi.',
                'rt.required'  => 'RT wajib diisi.',
                'rw.required'  => 'RW wajib diisi.',
                'desa.required'  => 'Desa/Kelurahan wajib diisi.',
                'kecamatan.required'  => 'Kecamatan wajib diisi.',
                'kab.required'  => 'Kabupaten wajib diisi.',
                'prov.required'  => 'Provinsi wajib diisi.',
                'kode_pos.required'  => 'Isikan Kode Pos.',
                ...
                'no_telp_ayah.required'  => 'Nomor Telephone Ayah wajib diisi.',
                'instansi_ayah.required'  => 'Instansi Ayah wajib diisi.',
                'alamat_kerja_ayah.required'  => 'Alamat Kerja Ayah wajib diisi.',
                'penghasilan_ayah.required'  => 'Penghasilan Ayah wajib diisi.',
                'id_pendidikan_ayah.required'  => 'Kolom Pendidikan Ayah wajib diisi.',
                ...
                'no_tlp_ibu.required' => 'Nomor Telephone Ibu wajib diisi.',
                'instansi_kerja_ibu.required' => 'Instansi Ibu wajib diisi.',
                'alamat_kerja_ibu.required' => 'Alamat Kerja Ibu wajib diisi.',
                'penghasilan_ibu.required' => 'Penghasilan Ibu wajib diisi.',
                'id_pendidikan_ibu.required' => 'Kolom Pendidikan Ibu wajib diisi.',
                'no_wa.required' => 'Perhatikan Isian Nomor WA Orangtua/Wali.',
                'email_ortu.required' => 'Perhatikan Isian Email Orangtua/Wali.',
                'jarak.required' => 'Isikan Kolom Jarak.',
                'id_jenis_transport.required' => 'Mohon Pilih Jenis Transportasi.',
                'hobi_anak.required' => 'Perhatikan Kolom Hobi',
                'ket_tinggal.required' => 'Keterangan Tinggal Wajib Diisi.',
                'anak_ke.required' => 'Anak Ke- Wajib diisi.',
                'jml_saudara.required' => 'Jumlah Saudara Wajib Diisi.',
                'brp_saudara.required' => 'Perhatikan Kolom Berapa Saudara',
                'id_goldar.required' => 'Perhatikan Kolom Golongan Darah',
                'bb.required' => 'Isikan Berat Badan.',
                'tb.required' => 'Isikan Tinggi Badan.',
                'riwayat_penyakit.required' => 'Perhatikan Kolom Riwayat Penyakit.',
                'kelainan_jasmani.required' => 'Perhatikan Kolom Kelainan Jasmani',
                'alergi.required' => 'Perhatikan Kolom Riwayat Alergi',
        ...
        return redirect('/daftarsiswa')->with('pesan', 'Data Berhasil Disimpan.');
    }
}
